...
const WHERE = {
  ...
  episode: 'The episode-complete card (v6.3)',
...
const NOTES = {
  ...
  'slot.hand': "His hand — the torch goes here",
  ...
  'item.torch.desc': 'Shown beside the torch in the equipment panel',
  'inv.zoom': 'Read aloud for the magnifying-glass button — never seen',
  'inv.zoomClose': 'Closes the big item view',
  'inv.zoomHint': 'The how-to line under the big item view',
  ...
  'episode.label': 'The small line above the big rank',
  'episode.stamp': 'The red stamp across the rank — keep it short',
  'episode.scoreLabel': 'Beside the episode\'s average score',
  'episode.tallyLabel': 'Above the row of five chapter results',
  'episode.mapLabel': 'Above the trail of ten cases',
  'episode.unlocked': 'The small flag on the next case in the trail',
  'episode.next': 'Under the trail when the next case exists — {episode} is filled in for you',
  'episode.nextUnwritten': 'Under the trail when the next case is not written yet — {episode} is filled in for you',
  'episode.allDone': 'Under the trail after the tenth case',
  'episode.continue': 'The button when the next case exists',
  'episode.toTitle': 'The button when it does not',
