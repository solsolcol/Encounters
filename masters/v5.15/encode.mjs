...
const OUT = '/tmp/claude-0/-home-user-Encounters/f1062235-ca86-59a9-b000-61422c281293/scratchpad/enc';
const install = process.argv.includes('--install');
const p = JSON.parse(fs.readFileSync('masters/v5.15/progress.json', 'utf8'));
...
for (const l of p.lines) {
  const master = `masters/v5.15/${l.id}.mp3`;
