...
(function () {
  ...
  const LINES = [
    ...
    { id: "voice", who: "james", ch: "ch1", where: "A few seconds after chapter 1 begins",
      text: "Almost midnight... and this is still the fastest way home.", secs: 4.36,
    ...
    { id: "vpile", who: "james", ch: "ch1", where: "The first time you come near the burner",
      text: "Someone's been burning offerings. [beat] It's not even Seventh Month.", secs: 5.07 },
    { id: "vnote", who: "james", ch: "ch1", where: "The first time the note prompt appears",
      text: "There's one right at my feet. Like it was left for me.", secs: 7.71 },
    { id: "vgasp", who: "james", ch: "ch1", where: "Scene A, when he looks up and she is there; also chapter 2 scene A",
      text: "[a sharp, frightened inhale] Oh my God.", secs: 2.12, note: "Meant as a wordless gasp; the take also says the words (found by transcription at v5.14, as vrelief's were at v4.8)." },
    { id: "vscoff", who: "james", ch: "ch1", where: "Scene B, on the kick",
      text: "[a short, dismissive laugh] It's just paper.", secs: 3.08, note: "Meant as a wordless scoff; the take also says the words (found by transcription at v5.14)." },
    { id: "vpant", who: "james", ch: "ch1", where: "Scene B, under the run; also chapter 3 scene B",
      text: "[running out of breath] No, no, no, no, no.", secs: 4.36, note: "Meant as wordless panting; the take also says the words (found by transcription at v5.14)." },
    { id: "vrelief", who: "james", ch: "ch1", where: "Scene C, after he walks away; also chapter 2 scenes B and D, chapter 3 scene D, chapter 4 scene D",
      text: "[a quiet, shaken exhale — no words]", secs: 3.79,
    ...
    { id: "vchantline", who: "james", ch: "ch1", where: "Not used",
      text: "Namo tassa bhagavato arahato sammāsambuddhassa. I'm sorry. I'll go.", secs: 9.33,
    ...
    { id: "vA", who: "james", ch: "ch1", where: "Under the outcome card after choice A",
      text: "It's just paper. [beat] So why does my hand feel like it's holding something heavier?", secs: 6.84 },
    { id: "vB", who: "james", ch: "ch1", where: "Under the outcome card after choice B",
      text: "[panting] I shouldn't have done that. I knew it the second my foot touched it.", secs: 5.72 },
    { id: "vC", who: "james", ch: "ch1", where: "Under the outcome card after choice C",
      text: "Look first. That's all it takes. Just... look first.", secs: 7.08 },
    { id: "vD", who: "james", ch: "ch1", where: "Under the outcome card after choice D",
      text: "Not my offering. Not my business. [exhale] Rest well, whoever you are.", secs: 6.69 },
    ...
    { id: "vghost", who: "james", ch: "haunting", where: "The first time she is seen",
      text: "Am I... seeing things?", secs: 3.08, note: "Whispered." },
    ...
    { id: "v2wake2", who: "james", ch: "ch2", where: "Opening film, and nothing answers",
      text: "Ma? Ma, is that you?", secs: 3.32 },
    { id: "v2wake3", who: "james", ch: "ch2", where: "Opening film, under the fade",
      text: "There is someone in the room.", secs: 2.12 },
    { id: "v2near", who: "james", ch: "ch2", where: "Nearing the gap beside the bed",
      text: "It keeps coming from over there, the wall side.", secs: 3.97 },
    { id: "v2gap", who: "james", ch: "ch2", where: "At the gap, when the prompt appears",
      text: "I have slept beside that gap my whole life. I never once looked into it.", secs: 6.35 },
    { id: "v2call", who: "james", ch: "ch2", where: "Scene B, calling for Ma",
      text: "MA! MA, COME HERE! PLEASE!", secs: 4.68, note: "Shouted." },
    ...
    { id: "v2A", who: "james", ch: "ch2", where: "Under the outcome card after choice A",
      text: "It was already looking at me. It had been the whole time.", secs: 4.99 },
    { id: "v2B", who: "james", ch: "ch2", where: "Under the outcome card after choice B",
      text: "She did not even ask what was wrong. She just came.", secs: 5.07 },
    { id: "v2C", who: "james", ch: "ch2", where: "Under the outcome card after choice C",
      text: "I did not run. I just left. Nobody tells you that is allowed.", secs: 6.43 },
    { id: "v2D", who: "james", ch: "ch2", where: "Under the outcome card after choice D",
      text: "Nothing happened. That is not the same as nothing being there.", secs: 4.83 },

    // ---- chapter 3 · THE GATHERING ------------------------------------------
    { id: "v3wake1", who: "james", ch: "ch3", where: "Opening film",
      text: "They put the tent up on Monday. It is still going.", secs: 3.79 },
    { id: "v3wake2", who: "james", ch: "ch3", where: "Opening film",
      text: "My mother told me not to come down. I came down.", secs: 4.28 },
    ...
    { id: "v3chair", who: "james", ch: "ch3", where: "Opening film, on the one chair",
      text: "There's one chair facing the wrong way. Just one.", secs: 4.60 },
    { id: "v3out1", who: "james", ch: "ch3", where: "Opening film, seeing her on the tarmac",
      text: "She's out there! Standing outside...", secs: 2.59, note: "Re-said in Chad's words at v4.5." },
    { id: "v3out2", who: "james", ch: "ch3", where: "Opening film, the last line",
      text: "She's not coming in.", secs: 1.49 },
    { id: "v3play", who: "james", ch: "ch3", where: "A few seconds after chapter 3 begins",
      text: "I feel better here... but why?", secs: 3.16, note: "Re-said in Chad's words at v4.5." },
    { id: "v3altar", who: "james", ch: "ch3", where: "At the altar, when the prompt appears",
      text: "He has not blinked. Not once.", secs: 3.47 },
    { id: "v3seen", who: "james", ch: "ch3", where: "Scene A",
      text: "He looked at me. Out of all of them... he looked at me.", secs: 8.36 },
    { id: "v3grip", who: "james", ch: "ch3", where: "Scene B",
      text: "His eyes were shut. He was looking at me with his eyes shut.", secs: 4.83 },
    ...
    { id: "v3ask", who: "james", ch: "ch3", where: "Scene C",
      text: "Is it real, auntie?", secs: 1.49 },
    { id: "v3aunt3", who: "auntie", ch: "ch3", where: "Scene C",
      text: "Real, not real, I do not know. I know he wakes up tomorrow and drives a lorry.", secs: 6.35 },
    { id: "v3aunt4", who: "auntie", ch: "ch3", where: "Scene C, her last word",
      text: "Listen to me, boy. Do not sit in the back row today.", secs: 4.13,
    ...
    { id: "v4call1", who: "james", ch: "ch4", where: "Scene D, on the phone",
      text: "Ma. It's me... no— something's wrong with the flat.", secs: 5.96 },
    { id: "v4call2", who: "james", ch: "ch4", where: "Scene D, on the phone",
      text: "I know how it sounds. Please.", secs: 3.08 },
    { id: "v4ma2", who: "mother", ch: "ch4", where: "Scene D, the promise",
      text: "Listen to me. Tomorrow I ask the temple to send the tang-ki down. He will come and check the whole house. Tonight you don't touch anything, you hear me?", secs: 8.99, note: "Heard through the handset." },
    ...
    { id: "v5wake2", who: "james", ch: "ch5", where: "Opening film, the bow to the kitchen",
      text: "Why is he bowing to the kitchen.", secs: 2.19 },
    ...
    { id: "v5wake3", who: "james", ch: "ch5", where: "Opening film, the last line",
      text: "That's the note. From the void deck. It's been here the whole time.", secs: 6.84 },
    { id: "v5voice", who: "james", ch: "ch5", where: "A few seconds after chapter 5 begins",
      text: "Ma made tea. He hasn't touched his.", secs: 3.63 },
    { id: "v5near", who: "james", ch: "ch5", where: "Nearing the tang-ki",
      text: "He walks the flat like he's reading it.", secs: 2.27 },
    { id: "v5sit", who: "james", ch: "ch5", where: "At the tang-ki, when the prompt appears",
      text: "Uncle. What did you see?", secs: 2.35 },
    { id: "t5teachA", who: "tangki", ch: "ch5", where: "Scene A, the teaching at the table",
      text: "Do not assume. Do not provoke. Observe. Understand the circumstances. Seek knowledge before you act. [beat] Last night, you finally did the fourth. That is why this morning is quiet.", secs: 14.76,
    ...
    { id: "t5fearB", who: "tangki", ch: "ch5", where: "Scene B, cutting through the fear",
      text: "What you saw in the night was real. What you are seeing now — this fear — is yours, not its.", secs: 9.33 },
    { id: "v5fearB1", who: "james", ch: "ch5", where: "Scene B, after the release",
      text: "The room didn't change. It was me.", secs: 3.55, note: "Shaky. Transcribed from the shipped take at v5.14." },
    { id: "v5disC1", who: "james", ch: "ch5", where: "Scene C, turning his back on the note",
      text: "Paper. It's just paper.", secs: 2.43 },
    { id: "t5disC", who: "tangki", ch: "ch5", where: "Scene C, quietly, behind him",
      text: "You may call it paper. [beat] Paper burns either way.", secs: 4.91 },
    ...
    { id: "v5learnD", who: "james", ch: "ch5", where: "Scene D, quietly, at the end",
      text: "The first one. He says every case teaches you the next.", secs: 5.15 },
    { id: "v5A", who: "james", ch: "ch5", where: "Under the outcome card after choice A",
      text: "I asked him what to learn. He told me. All of it.", secs: 4.60 },
    { id: "v5B", who: "james", ch: "ch5", where: "Under the outcome card after choice B",
      text: "The fear followed me into the morning. That part was mine.", secs: 4.52 },
    { id: "v5C", who: "james", ch: "ch5", where: "Under the outcome card after choice C",
      text: "I called it paper. The flat heard me.", secs: 3.32 },
    { id: "v5D", who: "james", ch: "ch5", where: "Under the outcome card after choice D",
      text: "It's over. [beat] It's really over.", secs: 4.21 }
  ];
