...
(function () {
  ...
  const LINES = [
    ...
    { id: "v3wake1", who: "james", ch: "ch3", where: "Opening film",
      text: "They put the tent up on Monday. It is still going.", secs: 2.77 },
    ...
    { id: "v3wake3", who: "james", ch: "ch3", where: "Opening film, over the crowd",
      text: "Everyone seems fascinated by the performance...", secs: 2.93, note: "Re-said in Chad's words at v4.5." },
    ...
    { id: "v3out2", who: "james", ch: "ch3", where: "Opening film, the last line",
      text: "She's not coming in.", secs: 2.27 },
    ...
    { id: "v3left", who: "james", ch: "ch3", where: "Scene D, leaving",
      text: "I could still hear the drum from the lift. I told myself that was normal.", secs: 5.41 },
    ...
    { id: "v3C", who: "james", ch: "ch3", where: "Under the outcome card after choice C",
      text: "She told me the truth. Both halves of it.", secs: 2.59 },
    ...
    { id: "v4sit", who: "james", ch: "ch4", where: "At the chair when the prompt appears, and again as scene A sits down",
      text: "Start from the beginning.", secs: 1.07 },
    ...
    { id: "v4thinkA3", who: "james", ch: "ch4", where: "Scene A, the red chair memory",
      text: "Same block. Same week. Same me. It's not the places — it's following me.", secs: 6.11 },
