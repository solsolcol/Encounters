...
(function () {
  ...
  const LINES = [
    ...
    { id: "v3aunt6", who: "auntie", ch: "ch3", where: "Play, the amulet: when he picks it up off her table",
      text: "Ah boy, you like this one? Auntie give it to you, keep it well!", secs: 4.99,
      note: "v14.7, Chad's words. Take d of four (masters/v14.7), picked by pitch and balance against her four shipped lines." },
    ...
    /* v13.2 — Chad's rewrite of the four outcome scenes. */
    { id: "n4draw", who: "jamesTeen", ch: "e2c4", where: "Scene B: as he steps forward of the firing line",
      text: "[uneasy] Somehow I feel drawn to investigate more. Surely my eyes weren't playing tricks on me.", secs: 5.15, note: "Chad's own words." },
    { id: "n4gasp", who: "jamesTeen", ch: "e2c4", where: "Scene C: the 180 turn, and it is standing behind him",
      text: "[gasps in terror] Haaah—!", secs: 1.07, note: "Wordless. The direction IS the take (v4.8's rule)." },
    { id: "n4runD", who: "jamesTeen", ch: "e2c4", where: "Scene D: off the line, running",
      text: "[panicking] No. No, no— I'm not staying out here!", secs: 2.51 },
    { id: "n4pant", who: "jamesTeen", ch: "e2c4", where: "Scene D: the breathing under the run, and under the faint",
      text: "[breathing hard, terrified] Hah... hah... hah... hah...", secs: 3.16, note: "Wordless. Routed round the voice bus is NOT needed — it is a spoken-level take, not a whisper." },
    ...
    { id: "t4who", who: "tower", ch: "e2c4", where: "Play: the tower answers the player's own first round, and scene C",
      text: "CEASE FIRE! Who fired? Lane six. What are you firing at?", secs: 4.72, note: "Bark rule. v14.3: LANE SIX, because the tower is challenging the PLAYER (Chad: 'the voicelines keep referring to lane 5, when it should say lane 6 at the player instead') - and the cue moved onto the player's own round so that it is true." },
    ...
    { id: "b4there", who: "buddyC3", ch: "e2c4", where: "Not cued since v13.0 - the buddy's own shout says it in Chad's words. Kept in the pack.",
