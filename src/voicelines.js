...
(function () {
  ...
  const LINES = [
    ...
    { id: "voice", who: "james", ch: "ch1", where: "A few seconds after chapter 1 begins",
      text: "Almost midnight... and this is the only way home.", secs: 4.36,
    ...
    { id: "vpile", who: "james", ch: "ch1", where: "The first time you come near the burner",
      text: "Someone's been burning offerings. [beat] Is it Seventh Month already?", secs: 5.07 },
    ...
    { id: "v2near", who: "james", ch: "ch2", where: "Nearing the gap beside the bed",
      text: "It keeps coming from over there, from the wall.", secs: 3.97 },
    { id: "v2gap", who: "james", ch: "ch2", where: "At the gap, when the prompt appears",
      text: "I have slept beside that gap my whole life. Never has this happened.", secs: 6.35 },
    ...
    { id: "v2B", who: "james", ch: "ch2", where: "Under the outcome card after choice B",
      text: "She did not even ask what was wrong. She just left.", secs: 5.07 },
    { id: "v2C", who: "james", ch: "ch2", where: "Under the outcome card after choice C",
      text: "I'm leaving this room. I will sleep in the living room tonight.", secs: 6.43 },
    ...
    { id: "v3wake2", who: "james", ch: "ch3", where: "Opening film",
      text: "My mother told me not to come down. I came down anyway.", secs: 4.28 },
    ...
    { id: "v3aunt3", who: "auntie", ch: "ch3", where: "Scene C",
      text: "Real, not real, I don't know. I know he wakes up tomorrow and drives a lorry.", secs: 6.35 },
    { id: "v3aunt4", who: "auntie", ch: "ch3", where: "Scene C, her last word",
      text: "Listen to me, ah boy. Do not sit in the back row today.", secs: 4.13,
    ...
    { id: "v4regret", who: "james", ch: "ch4", where: "Scene C, after everything stops",
      text: "okay... okay. stupid. stupid. stupid me...", secs: 5.64, note: "Whispered." },
    ...
    { id: "v4ma2", who: "mother", ch: "ch4", where: "Scene D, the promise",
      text: "Listen to me. Tomorrow I ask the temple to send the tang-ki down. He will come and check the whole house. Tonight you don't touch anything ah, you hear me?", secs: 8.99, note: "Heard through the handset." },
    ...
    { id: "v5wake2", who: "james", ch: "ch5", where: "Opening film, the bow to the kitchen",
      text: "Why is he bowing at the kitchen.", secs: 2.19 },
    ...
    { id: "v5wake3", who: "james", ch: "ch5", where: "Opening film, the last line",
      text: "That's the hell note. From the void deck. It's been here the whole time.", secs: 6.84 },
    { id: "v5voice", who: "james", ch: "ch5", where: "A few seconds after chapter 5 begins",
      text: "Do I...approach him?", secs: 3.63 },
    { id: "v5near", who: "james", ch: "ch5", where: "Nearing the tang-ki",
      text: "He walked around the flat like he's reading it.", secs: 2.27 },
    ...
    { id: "t5teachA", who: "tangki", ch: "ch5", where: "Scene A, the teaching at the table",
      text: "Think back. Understand what you did. Seek help before you act. [beat] You know you've done wrong. That is why this morning is quiet.", secs: 14.76,
    ...
    { id: "t5fearB", who: "tangki", ch: "ch5", where: "Scene B, cutting through the fear",
      text: "I cannot help you if you do not open up. But you already know what you did wrong...", secs: 9.33 },
    { id: "v5fearB1", who: "james", ch: "ch5", where: "Scene B, after the release",
      text: "I should never have asked for help. I sound...crazy.", secs: 3.55, note: "Shaky. Transcribed from the shipped take at v5.14." },
    ...
    { id: "t5disC", who: "tangki", ch: "ch5", where: "Scene C, quietly, behind him",
      text: "You may call it paper. [beat] Paper burns, and now you're caught in its fire...", secs: 4.91 },
    ...
    { id: "v5B", who: "james", ch: "ch5", where: "Under the outcome card after choice B",
      text: "The fear followed me into the morning. When will it go away?", secs: 4.52 },
    { id: "v5C", who: "james", ch: "ch5", where: "Under the outcome card after choice C",
      text: "I called it paper. She heard me.", secs: 3.32 },
