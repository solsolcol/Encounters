...
(function () {
  ...
  const LINES = [
    ...
    { id: "voice", who: "james", ch: "ch1", where: "A few seconds after chapter 1 begins",
      text: "Almost midnight... and this is the only way home.", secs: 4.60,
    ...
    { id: "vnote", who: "james", ch: "ch1", where: "The first time the note prompt appears",
      text: "There's one right at my feet. Like it was left for me.", secs: 3.97 },
    { id: "vgasp", who: "james", ch: "ch1", where: "Scene A, when he looks up and she is there; also chapter 2 scene A",
      text: "[a sharp, frightened inhale] Oh my God.", secs: 2.35, note: "Meant as a wordless gasp; the take also says the words (found by transcription at v5.14, as vrelief's were at v4.8)." },
    ...
    { id: "vrelief", who: "james", ch: "ch1", where: "Scene C, after he walks away; also chapter 2 scenes B and D, chapter 3 scene D, chapter 4 scene D",
      text: "[a quiet, shaken exhale — no words]", secs: 4.52,
    ...
    { id: "vchantline", who: "james", ch: "ch1", where: "Not used",
      text: "Namo tassa bhagavato arahato sammāsambuddhassa. I'm sorry. I'll go.", secs: 7.16,
    ...
    { id: "vA", who: "james", ch: "ch1", where: "Under the outcome card after choice A",
      text: "It's just paper. [beat] So why does my hand feel like it's holding something heavier?", secs: 5.07 },
    { id: "vB", who: "james", ch: "ch1", where: "Under the outcome card after choice B",
      text: "[panting] I shouldn't have done that. I knew it the second my foot touched it.", secs: 4.21 },
    { id: "vC", who: "james", ch: "ch1", where: "Under the outcome card after choice C",
      text: "Look first. That's all it takes. Just... look first.", secs: 4.91 },
    { id: "vD", who: "james", ch: "ch1", where: "Under the outcome card after choice D",
      text: "Not my offering. Not my business. [exhale] Rest well, whoever you are.", secs: 5.72 },
    ...
    { id: "vghost", who: "james", ch: "haunting", where: "The first time she is seen",
      text: "Am I... seeing things?", secs: 4.05, note: "Whispered." },
    ...
    { id: "v2A", who: "james", ch: "ch2", where: "Under the outcome card after choice A",
      text: "It was already looking at me. It had been the whole time.", secs: 3.79 },
    { id: "v2B", who: "james", ch: "ch2", where: "Under the outcome card after choice B",
      text: "She did not even ask what was wrong. She just left.", secs: 3.32 },
    { id: "v2C", who: "james", ch: "ch2", where: "Under the outcome card after choice C",
      text: "I'm leaving this room. I will sleep in the living room tonight.", secs: 3.40 },
    { id: "v2D", who: "james", ch: "ch2", where: "Under the outcome card after choice D",
      text: "Nothing happened. That is not the same as nothing being there.", secs: 3.97 },

    // ---- chapter 3 · THE GATHERING ------------------------------------------
    { id: "v3wake1", who: "james", ch: "ch3", where: "Opening film",
      text: "They put the tent up on Monday. It is still going.", secs: 3.08 },
    { id: "v3wake2", who: "james", ch: "ch3", where: "Opening film",
      text: "My mother told me not to come down. I came down anyway.", secs: 3.63 },
    { id: "v3wake3", who: "james", ch: "ch3", where: "Opening film, over the crowd",
      text: "Everyone seems fascinated by the performance...", secs: 2.69, note: "Re-said in Chad's words at v4.5." },
    { id: "v3wake4", who: "james", ch: "ch3", where: "Not used",
      text: "That one is looking at me. Nobody else is.", secs: 2.77,
    ...
    { id: "v3out1", who: "james", ch: "ch3", where: "Opening film, seeing her on the tarmac",
      text: "She's out there! Standing outside...", secs: 2.35, note: "Re-said in Chad's words at v4.5." },
    { id: "v3out2", who: "james", ch: "ch3", where: "Opening film, the last line",
      text: "She's not coming in.", secs: 1.31 },
    { id: "v3play", who: "james", ch: "ch3", where: "A few seconds after chapter 3 begins",
      text: "I feel better here... but why?", secs: 2.35, note: "Re-said in Chad's words at v4.5." },
    ...
    { id: "v3seen", who: "james", ch: "ch3", where: "Scene A",
      text: "He looked at me. Out of all of them... he looked at me.", secs: 4.44 },
    { id: "v3grip", who: "james", ch: "ch3", where: "Scene B",
      text: "His eyes were shut. He was looking at me with his eyes shut.", secs: 4.36 },
    ...
    { id: "v3ask", who: "james", ch: "ch3", where: "Scene C",
      text: "Is it real, auntie?", secs: 1.15 },
    ...
    { id: "v4wake3am", who: "james", ch: "ch4", where: "Scene B, waking at 3 a.m.",
      text: "...the clock. Why can't I hear the clock?", secs: 3.24, note: "Whispered." },
    { id: "v4taunt", who: "james", ch: "ch4", where: "Scene C, to the empty flat",
      text: "You want me?! I'm right here! Come out where I can SEE you!", secs: 5.96, note: "Shouted." },
    { id: "v4regret", who: "james", ch: "ch4", where: "Scene C, after everything stops",
      text: "okay... okay. stupid. stupid. stupid me...", secs: 6.19, note: "Whispered." },
    ...
    { id: "v4call2", who: "james", ch: "ch4", where: "Scene D, on the phone",
      text: "I know how it sounds. Please.", secs: 2.43 },
    ...
    { id: "v5voice", who: "james", ch: "ch5", where: "A few seconds after chapter 5 begins",
      text: "Do I...approach him?", secs: 2.43 },
    { id: "v5near", who: "james", ch: "ch5", where: "Nearing the tang-ki",
      text: "He walked around the flat like he's reading it.", secs: 2.19 },
    { id: "v5sit", who: "james", ch: "ch5", where: "At the tang-ki, when the prompt appears",
      text: "Uncle. What did you see?", secs: 1.88 },
    ...
    { id: "v5fearB1", who: "james", ch: "ch5", where: "Scene B, after the release",
      text: "I should never have asked for help. I sound...crazy.", secs: 4.36, note: "Shaky. Transcribed from the shipped take at v5.14." },
    { id: "v5disC1", who: "james", ch: "ch5", where: "Scene C, turning his back on the note",
      text: "Paper. It's just paper.", secs: 2.51 },
    ...
    { id: "v5learnD", who: "james", ch: "ch5", where: "Scene D, quietly, at the end",
      text: "The first one. He says every case teaches you the next.", secs: 4.91 },
    { id: "v5A", who: "james", ch: "ch5", where: "Under the outcome card after choice A",
      text: "I asked him what to learn. He told me. All of it.", secs: 4.52 },
    { id: "v5B", who: "james", ch: "ch5", where: "Under the outcome card after choice B",
      text: "The fear followed me into the morning. When will it go away?", secs: 4.13 },
    { id: "v5C", who: "james", ch: "ch5", where: "Under the outcome card after choice C",
      text: "I called it paper. She heard me.", secs: 2.43 },
    { id: "v5D", who: "james", ch: "ch5", where: "Under the outcome card after choice D",
      text: "It's over. [beat] It's really over.", secs: 2.85 }
  ];
