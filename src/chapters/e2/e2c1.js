...
(() => {
  ...
  const DATA = {
    ...
    core: 'Attention is not neutral. To acknowledge a presence is to open a connection that was not there. If nothing is asking anything of you, give it nothing.<br><i>What you attend to, attends to you.</i>',
