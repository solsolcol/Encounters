...
Object.assign(window.__TEXT__, {
  ...
  'menu.chapters':       'Episodes and chapters',
  'menu.toTitle':        'Back to the title screen',
  'chapters.heading':    'Episodes',
  'chapters.hint':       'Pick an episode, then a chapter you have reached, to play it again from its opening.',
  ...
  /* v14.13: Chad's LP Tim Khun Paen — his words, both, verbatim, with the
     temple's name corrected by him at v14.14 ("The correct name should be
